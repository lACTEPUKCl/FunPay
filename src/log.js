...
const by = 'By Shadow-Thunder04\n';
const enableFileLog = true;

// START
if(enableFileLog) logToFile('---------------New Load--------------');
setTerminalTitle('FunPay Server by Shadow-Thunder04');
printLogo();
...
function printLogo() {
    ...
    console.log(c.greenBright(` *Telegram: https://t.me/shadow_thunder`));
    console.log(c.greenBright(` *Discord:  https://discord.gg/upd3RaXHhE`));
    console.log(c.greenBright(` *Github:   https://github.com/Shadow-Thunder04/FunPay\n`));
}
